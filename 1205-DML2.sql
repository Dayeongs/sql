...
/*
    ...
    VARCHAR2
        해당 컬럼의 데이터타입을 가변길이 문자형으로 지정한다.
        VARCHAR2(255)는 영어로 255자까지 가능하고, 한글은 3바이트이므로 85자까지 가능하다.
    DATE
...
INSERT INTO SAMPLE_BOOKS
VALUES(15, '자존감 수업', '윤홍균', 15300, 7, SYSDATE);
...
/*
    ...
    * WHERE절의 조건식은 언제나 특정 행 하나만 삭제되도록 조건식을 작성하자.
     (특정 행 하나만 삭제되도록 하기 위해선 조건식은 해당 테이블에서 
