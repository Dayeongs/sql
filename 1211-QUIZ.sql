...
-- 20번 혹은 50번 부서에 소속된 직원의 이름과 부서번호를 조회하고, 
-- 이름을 알파벳순으로 정렬해서 조회하기
...
-- 178번은 DEPARTMENT_ID, LOCATION_ID가 NULL이기 때문에 LEFT OUTER JOIN을 둘 다 해야한다.
...
-- 모든 직원의 아이디, 이름, 급여, 커미션을 고려한 급여, 급여등급, 직종아이디, 소속부서아이디, 소속부서명, 근무지 도시명을 조회하기 
