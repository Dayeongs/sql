...
INSERT INTO PROFESSORS (PROF_NO, PROF_NAME, PROF_POSITION, DEPT_NO)
VALUES (204, '박교수', '정교수', 100); -- 부모키가 없어서 저장되지 않음

DELETE FROM DEPTS
WHERE DEPT_NO = 101; -- 참조하는 자식레코드가 존재하기 때문에 삭제되지 않음
...
-- 테이블 삭제하기
DROP TABLE DEPTS;       -- PROFESSORS, STUDENTS, COURSES에서 참조하고 있다.
DROP TABLE PROFESSORS;  -- STUDENTS, COURSES에서 참조하고 있다.
DROP TABLE STUDENTS;    -- REQUESTS에서 참조하고 있다.
DROP TABLE COURSES;     -- REQUESTS에서 참조하고 있다.
